...
namespace Curudd.pbdDataSetTableAdapters {
...
SELECT ID, Name, Email, Birth, Sex FROM Mahasiswa WHERE (ID = @ID)";
        ...
        public virtual int Fill(pbdDataSet.MahasiswaDataTable dataTable) {
        ...
        public virtual pbdDataSet.MahasiswaDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            pbdDataSet.MahasiswaDataTable dataTable = new pbdDataSet.MahasiswaDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(pbdDataSet.MahasiswaDataTable dataTable) {
